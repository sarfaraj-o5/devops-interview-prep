...
STUDENT_WAR_FILE=https://raw.githubusercontent.com/sarfaraj-o5/devops-interview-prep/main/shell-scripting/application/student.war

#MySQl Connector
MYSQL_DRIVER=https://raw.githubusercontent.com/sarfaraj-o5/devops-interview-prep/main/shell-scripting/application/mysql-connector-5.1.18.jar
